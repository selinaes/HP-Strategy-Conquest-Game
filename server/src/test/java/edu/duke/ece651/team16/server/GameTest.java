...
// @Override
// public void run() {
// Game.doPlacementPhase(mockSocket, 1); // call the run() method of the Server
// instance
// }
// });
// testThread.start();
...
// .send(
// "Please enter a color you want to choose. Current available colors are: red
// blue ");
...
// .send("Please enter a color you want to choose. Current available colors are:
// red blue ");
...
// verify(connectionMock)
// .send("You are the first player! Please set the number of players in this
// game(Valid player number: 2-4): ");
// verify(connectionMock).recv();
// verify(connectionMock).send("Valid");
...
// // check the numPlayer and sent message
// verify(connectionMock).send("Not the first player. Please wait for the first
// player to set player number.");
// }
...
// verify(connectionMock, times(2)).recv(); // ensure recv method is called 2
// times
...
// HashMap<String, ArrayList<HashMap<String, String>>> expectedMap = new
// HashMap<>();
...
// HashMap<String, ArrayList<HashMap<String, String>>> actualMap =
// game.formMap();
// HashMap<String, ArrayList<HashMap<String, String>>> initialMap =
// game.formInitialMap();
...
// // Set up the Connection mock to return some values when send() and recv()
// are
// // called
...
// Player player = new Player("blue", connection, new ArrayList<Territory>(),
// 3);
